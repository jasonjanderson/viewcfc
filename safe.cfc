<cfcomponent output="no">
	...
	Function: safetext
	--------------------------------------------------------------------------
	  This is a third party function.  For details on origions, etc see the
	comments below.  This function removes any bad stuff from user input (ie.
	html).
	==========================================================================
	--->
	...
	function safetext(text) {
		...
		var badTags = "SCRIPT,OBJECT,APPLET,EMBED,FORM,LAYER,ILAYER,FRAME,IFRAME,FRAMESET,PARAM,META,IMG";
	...
	<cffunction name="SafeStruct" returntype="void">
		<cfargument name="struct" type="struct"> 
		
		<cfloop collection="#arguments.struct#" item="i">
			<cfset "arguments.struct.#i#" = This.SafeText(evaluate("arguments.struct.#i#"))>
		</cfloop>
	</cffunction>
</cfcomponent>